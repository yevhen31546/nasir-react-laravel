...
$('.wheel-table-cart .fa-times').on('click', function (e) {
   $(this).parent().parent().remove();
    ...
    $(function(){ /* DOM ready */
        ...
        $('#selectSavedAddressArrive').change(function () {
            var selected = $(this).find('option:selected');
            var lat = selected.data('lat');
            var leg = selected.data('let');
            var lieu = selected.text();
            ...
            $('#lieu_arrive_lat').val(lat);
            $('#lieu_arrive_let').val(leg);
            $('#ModalSavedAddressArrive').modal('toggle');
        });

        $('#selectSavedAddressDepart').change(function () {
            var selected = $(this).find('option:selected');
            var lat = selected.data('lat');
            var leg = selected.data('let');
            var lieu = selected.text();
            ...
            $('#lieu_depart_lat').val(lat);
            $('#lieu_depart_let').val(leg);
            $('#ModalSavedAddressDepart').modal('toggle');
        });
