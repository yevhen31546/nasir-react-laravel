                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="" class="style-msg errormsg  hidden">
                            <div id="" class="sb-msg">Erreur dans la modification, merci de réssayer</div>
                        </div>
                        <div  class="style-msg successmsg hidden">
                            <div id="error_msg" class="sb-msg"><i class="icon-remove"></i>Votre mot de passe est bien modifié</div>
                        </div>
                        <form class="row" id="event-login" enctype="multipart/form-data" novalidate="novalidate">
                            ...
                            <div class="col-12 form-group">
                                ...
                                <input type="password" name="password_verify"  class="form-control" value="" placeholder="">
                                <input type="hidden" name="code" value='{{$code}}' class="form-control" value="" placeholder="">
                                <input type="hidden" name="email" value='{{$email}}' class="form-control" value="" placeholder="">
                            </div>
...
@include('portail.js.changePassword')
@endsection
<style>
