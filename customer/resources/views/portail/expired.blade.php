...
<div class="section nobg notopmargin nopadding footer-stick">
    <div class="container clearfix">
        ...
        <div class=""></div>
                <div class="card">
                    <div class="card-header"><b>LIEN EXPIRE</b></div>
                    <div class="card-body">
                        <div id="error_div" class="style-msg errormsg">
                            <div class="sb-msg" >
                                Le lien a expiré ou est incorrect. <a href="{{url('/resetpassword')}}">Veuillez demander une nouvelle réinitialisation du mot de passe.</a>
                            </div>
                        </div>
                    </div>
                </div>
