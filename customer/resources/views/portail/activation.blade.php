                    ...
                    <div class="card-body">
                        ...
                        <form class="row" id="event-activation" enctype="multipart/form-data" novalidate="novalidate">
                            ...
                            <div class="col-12 form-group">
                                <div id="sms1">
                                   @if(Session::has('form_insc') && Session::get('form_insc') == 'true')
                                <script>                          
                                    jQuery(document).ready(function () {
                                        $("#pre").val("{{Session::get('pre_insc')}}");       
                                    });
                                </script>
                                <label style="align-items: center">Téléphone : {{Session::get('pre_insc')}}{{Session::get('telephone_insc')}}</label>
                                <p>
                                    Bonjour {{Session::get('prenom_insc')}},<br><br>
                                    Nous vous avons envoyé un code d’activation par SMS au<b> {{Session::get('pre_insc')}}{{Session::get('telephone_insc')}}</b><br><br>
                                ...
                                <div id="sms2" class="hidden">
                                    ...
                                    <label style="align-items: center">Email : <label style="text-transform: lowercase">{{Session::get('email_insc')}}</label></label>
                                <p>
                                    Bonjour {{Session::get('prenom_insc')}},<br><br>
                                    Votre numéro  de téléphone <b>{{Session::get('pre_insc')}}{{Session::get('telephone_insc')}}</b> est désormais activé<br><br>
                                    Vous allez recevoir un e-mail sur votre boite e-mail : <b>{{Session::get('email_insc')}}</b><br><br>
                                ...
                                <p>
                                    Bonjour {{Session::get('prenom_insc')}},<br><br>
                                    Votre compte Weekab <b>{{Session::get('email_insc')}}</b> est validée<br><br>
                        ...
                        <div class="col-12 row hidden" id="formemail">
                            <div class="col-2"></div>
                            <div class="col-8">
