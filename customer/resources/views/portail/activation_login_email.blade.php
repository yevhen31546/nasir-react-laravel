                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row" id="event-activation" enctype="multipart/form-data" novalidate="novalidate">
                                ...
                                <div class="col-12 form-group">
                                    <div id="sms2" class="">
                                        ...
                                        <div class="col-12 row " id="formemail">
                                            <div class="col-2"></div>
                                            <div class="col-8">
                                                <button type="button"  onclick="sendemail();" class="button button-3d button-rounded btn-block nomargin" style="">Renvoyer un email</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 form-group">
                                    @if(Session::has('non_activation_sms') || Session::has('non_activation_sms_email'))
                                    <div id="sms1">
                                ...
                                <div class="col-12">
                                    <button type="submit" id="btn_sms" class="button button-3d button-rounded btn-block nomargin" style="">Activer votre Téléphone</button>
                                </div>
                                @endif
...
@include('portail.js.activation_login_email')
@endsection
